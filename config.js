...
//═══════[modification]════════\\
global.owner = process.env.owner || ['94770611075'] //owner number, u can put multiple owner number, within quotations and seperated by comma.
global.pemilik = ['94770611075'] //another owner number
global.premium = ['94770611075'] //premium number
global.pengguna = '𝘉𝘖𝘛 𝘔𝘋' //username
global.mongodb = process.env.MONGODB_URI || "Enter-MongoURI-HERE"

global.port = process.env.PORT || 5000
global.botnma = process.env.botnma || '𝘉𝘖𝘛 𝘔𝘋'//bot name
global.watermark = "ENJOY WITH PRAMAYA"
global.botname = process.env.botnamw || '𝘉𝘖𝘛 𝘔𝘋'
global.ownernma = 'x_ᴘʀᴀᴍᴀʏᴀ_x' //owner name
global.ownername = process.env.ownername || 'Ikshwaku Pandey' //owner name
global.packname = 'Zero-Two' //sticker package name
global.author = 'x_ᴘʀᴀᴍᴀʏᴀ_x' //sticker author name
global.sessionNamew = 'session.sam'
global.sessionName = process.env.SESSION_ID || 'No-Session'
global.zerotwo = "https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E" //ur gc link
global.zerotwo2 = "https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E" //ur gc link2
